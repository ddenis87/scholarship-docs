...
## Форма элемента
<b>Компонент:</b> ElementCatalogcalculation
...
## Форма списка
<b>Компонент:</b> ListCatalogcalculation
...
## Табличные части
___1. Стоимостные группы___

<b>Компонент:</b> Tablecatalogcalculationcostgroup

___2. Услуги___

<b>Компонент:</b> Tablecatalogcalculationservice
