# Регистрация значений показателей

## Форма элемента
<b>Компонент:</b> ElementDocumentregistrationindicatorvalues
...
## Форма списка
<b>Компонент:</b> ListDocumentregistrationindicatorvalues
...
## Табличные части
___1. Значения показателей___

<b>Компонент:</b> Tabledocumentregistrationindicatorvalues
